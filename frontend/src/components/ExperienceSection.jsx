			...
			{isEditing && (
				<div className='mt-4'>
					...
					<button
						...
						className='bg-violet-600 text-white py-2 px-4 rounded hover:bg-violet-600 transition duration-300'
					>
						Add Experience
					</button>
				</div>
			...
			{isOwnProfile && (
				<>
					{isEditing ? (
						<button
							onClick={handleSave}
							className='mt-4 bg-violet-600 text-white py-2 px-4 rounded hover:bg-yellow-900 transition duration-300'
						>
							Save Changes
						</button>
					) : (
